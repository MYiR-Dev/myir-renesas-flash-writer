...
# RZ/G2L Smarc PMIC Edition board
#--------------------------------------
FILENAME_ADD = _RZG2L_SMARC_PMIC_1GB
DEVICE   = RZG2L
DDR_TYPE = DDR4
DDR_SIZE = 1GB_1PCS
SWIZZLE  = T1BC
...
SWIZZLE  = T3BCUL
DEVICE_TYPE = 1
else ifeq ("$(BOARD)", "RZG2UL_SOC512M")
#--------------------------------------
# RZ/G2UL MYIR DDR3L Dev board 512M
#--------------------------------------
FILENAME_ADD = _RZG2UL_SOC512M
DEVICE   = RZG2UL
DDR_TYPE = DDR3L
DDR_SIZE = 512MB_1PCS
SWIZZLE  = T3BCUL
DEVICE_TYPE = 1
else ifeq ("$(BOARD)", "RZG2UL_SOC256M")
#--------------------------------------
# RZ/G2UL MYIR DDR3L Dev board 256M
#--------------------------------------
FILENAME_ADD = _RZG2UL_SOC256M
DEVICE   = RZG2UL
DDR_TYPE = DDR3L
DDR_SIZE = 256MB_1PCS
SWIZZLE  = T3BCUL
